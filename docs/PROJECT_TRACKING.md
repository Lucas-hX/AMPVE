...
4. Set In Progress only for actual work. Hardware required and Needs decision are explicit readiness states. Lucas's current Windows audit is in progress; its reported chip/security facts do not close backup or restoration acceptance.
