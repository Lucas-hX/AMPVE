...
Corrected reproduction evidence (2026-09-13): a clean pinned checkout exposed a stale incremental `ImprovService::feed` object caused by preserved source timestamps. The staging fix and rebuilt candidate now match the independently compiled clean artifacts. App: **2,877,360 bytes**, SHA-256 `9a324bc489c80db4f110ea7775f13b8aeef75dcf517f7b64d8b10a6e17427570`. Private `firmware-improv-reproduced-fixture` is traced to `5eee517`, testing-only/non-installable. See [the detailed correction and limits](FIRMWARE_REPRODUCIBILITY.md); the earlier incremental fixture is superseded.
