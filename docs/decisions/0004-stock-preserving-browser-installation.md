...
The C6 ESP-Hosted firmware is not contained in the P4 flash backup. Host component 2.12.13 remains pinned; its compatibility needs review. No C6 flashing is included. Native UI/peripheral initialization, network provisioning, startup and recovery require owner-local physical tests after approved first installation. On-device voice and Wi-Fi OTA remain separate workstreams.
